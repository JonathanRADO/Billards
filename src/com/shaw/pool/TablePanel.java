...
public class TablePanel extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		// g.fillRoundRect(BORDER_WIDTH, BORDER_WIDTH, WIDTH, HEIGHT,
		...
		for (int i = 0; i < pocket.length; i++) {
			// g.fillOval((int) (pocket[i].getPoint().getX() - Pocket.RADIUS +
			// BORDER_WIDTH), (int)(pocket[i].getPoint().getY() - Pocket.RADIUS +
			// BORDER_WIDTH), (int)(Pocket.RADIUS*2), (int)(Pocket.RADIUS*2));

			g.fillOval((int) (pocket[i].getPoint().getX() - Pocket.RADIUS),
					(int) (pocket[i].getPoint().getY() - Pocket.RADIUS), (int) (Pocket.RADIUS * 2),
					(int) (Pocket.RADIUS * 2));
		}
		...
		if (shootStrength != null) {
			...
			// System.out.println("radius = " + radius + "angle = " + angle + " ball " +
			// cueBall.getPosition().toString());
	...
	private void drawBall(Graphics g, Ball ball, int i) {
		...
		g.fillOval((int) (p.getX() - Ball.RADIUS), (int) (p.getY() - Ball.RADIUS), (int) (Ball.RADIUS * 2),
				(int) (Ball.RADIUS * 2));
